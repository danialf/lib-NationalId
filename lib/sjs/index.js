    ...
    execute: function () {
      ...
      NationalId = class NationalId {
        ...
        static IsValid(value) {
          ...
          const n = parseInt(value.charAt(0), 10) * 10 + parseInt(value.charAt(1), 10) * 9 + parseInt(value.charAt(2), 10) * 8 + parseInt(value.charAt(3), 10) * 7 + parseInt(value.charAt(4), 10) * 6 + parseInt(value.charAt(5), 10) * 5 + parseInt(value.charAt(6), 10) * 4 + parseInt(value.charAt(7), 10) * 3 + parseInt(value.charAt(8), 10) * 2;
          const r = n % 11;
